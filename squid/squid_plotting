...
class MPMS3Plotter:
    ...
    def plot_moment_vs_temp(self, show_error=False, mass_norm=False, mass_grams=None, **kwargs):
        """
        Convenience method to plot Moment vs Temperature (common plot).
        ...
        return self.plot(
            ...
            title='Magnetic Moment vs Temperature',
            **kwargs
        )


def plot_overlay(file_configs, x_column='Temperature (K)', y_column='Moment (emu)',
...
if __name__ == "__main__":
    ...
    file_configs = [
        {
            'path': r"C:\Users\fzy12567\OneDrive - Science and Technology Facilities Council\Ben Thompson 2025-2026 Onedrive\SQUID\3M 425 DWB - Magnetic Properties Test 251015\data\alu_tape_3M_425_DWB-15102025_FC_100G.dat",
            'label': "alu_tape_3M_425_DWB-15102025_FC_100G.dat",
            'color': 'yellow',
            'marker': 's',
            'mass_norm': True,
            'mass_grams': 0.04136,
        ...
        {
            'path': r"C:\Users\fzy12567\OneDrive - Science and Technology Facilities Council\Ben Thompson 2025-2026 Onedrive\SQUID\3M 425 DWB - Magnetic Properties Test 251015\data\alu_tape_3M_425_DWB-15102025_ZFC_100G.dat",
            'label': "alu_tape_3M_425_DWB-15102025_ZFC_100G.dat",
            'color': 'purple',
            'marker': 's',
            'mass_norm': True,
            'mass_grams': 0.04136,
    ...
    try:
        ...
        plot_overlay(
            ...
            x_column='Temperature (K)',
            y_column='Moment (emu)',
            title='Magnetic Moment vs Temperature - Overlay',
            xlabel='Temperature (K)',
